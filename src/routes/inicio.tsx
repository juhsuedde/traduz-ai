...
export const Route = createFileRoute("/inicio")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Converse com seu assistente de tradução." },
    ],
  }),
  component: ChatPage,
});
...
function ChatPage() {
  ...
  const send = () => {
    ...
    const next: ChatMessage[] = [
      ...
      { role: "assistant", content: "(Resposta simulada) Entendi — sugiro manter conciso e alinhado ao tom da marca." },
    ];
  ...
  return (
    <AppShell>
      <PageHeader title="Assistente" subtitle="Um segundo par de olhos, sempre por perto." />
          ...
          <div className="p-4 border-t border-white/40">
            <div className="flex items-end gap-2 bg-white/70 rounded-2xl p-2 pl-4">
              <textarea
                ...
                placeholder="Pergunte qualquer coisa — um ajuste de tom, um termo, uma reescrita…"
                rows={1}
